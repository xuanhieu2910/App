...
class GitClient extends vcs_1.Client {
    async ensureRepoExistsAsync() {
        ...
        try {
            ...
            log_1.default.error(`${chalk_1.default.bold('git')} found, but ${chalk_1.default.bold('git --help')} exited with status ${error === null || error === void 0 ? void 0 : error.status}${(error === null || error === void 0 ? void 0 : error.stderr) ? `:` : '.'}`);
            if (error === null || error === void 0 ? void 0 : error.stderr) {
                log_1.default.error(error === null || error === void 0 ? void 0 : error.stderr);
            }
